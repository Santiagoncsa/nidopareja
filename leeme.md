...
6. En el celular, las secciones (Gastos, Fondo común, Vencimientos, Tareas,
   Calendario) ya no aparecen como iconitos arriba: se abren tocando el
   logo **"Nido"**, en un panel lateral que se desliza desde la izquierda.
